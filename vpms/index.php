...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="assets/img/vpms1.png">
    ...
    <body id="page-top">
        ...
        <!-- Masthead-->
        style = "background-image: src("assets/img/vpms1.png")
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                <!-- Masthead Avatar Image-->
                <img class="masthead-avatar mb-5" src="assets/img/vpms1.png" alt="..." />
                <!-- Masthead Heading-->
